...
public class ConversationFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        String[] path = {"/backend/login/userLogin",
                "/backend/user/saveUser",
                "/backend/label/saveLabelProp1",
                "/backend/label/saveLabelProp2",
                "/backend/label/saveLabelProp3",
                "/backend/label/saveLabelProp4",
                "/backend/label/saveLabelProp5",
                "/backend/label/delLabel/{labelDimension}",
                "/backend/label/findAllLabelVal/{currPage}/{pageSize}",
                "/backend/label/findAllLabelVal"
        };
        boolean a = false;
        try {
